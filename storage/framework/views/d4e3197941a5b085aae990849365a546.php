...
<body>
    <div class="container">
        <div class="logo">
           <img src="<?php echo e($message->embed(public_path('/logo.png'))); ?>" alt="">
        </div>
        ...
        <div class="footer">
            ...
            <p>&copy; <?php echo e(date('Y')); ?> Lumbung Hijau. All rights reserved.</p>
        </div>
    </div>
</body>
</html> <?php /**PATH C:\lumbunghijau\backend\resources\views\emails\otp.blade.php ENDPATH**/ ?>